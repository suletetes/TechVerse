...
const ProductHighlights = () => {
    const highlights = [
        ...
        },
        {
            ...
            title: 'Trusted Brand',
            description: 'From a company with over 20 years of innovation and customer satisfaction.'
        },
        {
            color: '#198754',
            bgColor: 'rgba(25, 135, 84, 0.1)',
                    ...
                    <div className="flex-grow-1 d-flex flex-column justify-content-between">
                        <div className="highlights-list">
                            {highlights.map((highlight, index) => (
                                <div key={highlight.title} className={`highlight-item d-flex align-items-start ${index < highlights.length - 1 ? 'mb-4' : 'mb-4'}`}>
                                    <div
