 ...
 * Merges functionality from apiUtils.js and provides consistent API operations
 */

import { apiClient, handleApiResponse } from '../interceptors/index.js';

class ConsolidatedApiUtils {
  constructor() {
  ...
  async read(endpoint, params = {}, options = {}) {
    try {
      ...
      if (options.batch !== false) {
        const { default: requestBatcher } = await import('../services/requestBatcher.js');
  ...
  async invalidateCache(pattern) {
    try {
      const { default: intelligentCache } = await import('../services/intelligentCache.js');
  ...
  async getPerformanceStats() {
    try {
      const [
        ...
        import('../services/prefetchManager.js'),
        import('../services/requestBatcher.js')
      ]);
...
export default new ConsolidatedApiUtils();