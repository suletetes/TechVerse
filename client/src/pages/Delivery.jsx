            ...
            <div className="container bloc-md bloc-lg-md">
                <div className="row">
                    <div className="text-start offset-sm-1 col-sm-10 offset-lg-1 col-lg-10">
                        ...
                        <h3 className="mb-4 tc-6533">Standard Delivery</h3>
                        <p>
                        ...
                        <h3 className="mb-4 tc-6533">Express Delivery</h3>
                        <p>
                        ...
                        <h3 className="mb-4 tc-6533">Delivery Details</h3>
                        <p>
                        ...
                        <h3 className="mb-4 tc-6533">International Delivery</h3>
                        <p>
                        ...
                        <h3 className="mb-4 tc-6533">Need Help?</h3>
                        <p>
