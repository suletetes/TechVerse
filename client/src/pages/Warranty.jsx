            ...
            <div className="container bloc-md bloc-lg-md">
                <div className="row">
                    <div className="text-start offset-sm-1 col-sm-10 offset-lg-1 col-lg-10">
                        ...
                        <h3 className="mb-4 tc-6533">What does the warranty cover?</h3>
                        <p>
                        ...
                        <h3 className="mb-4 tc-6533">What is not covered?</h3>
                        <p>
                        ...
                        <h3 className="mb-4 tc-6533">How to claim warranty?</h3>
                        <p>
